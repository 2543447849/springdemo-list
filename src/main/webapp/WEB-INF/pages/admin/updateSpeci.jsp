...
<div class="container">
    ...
    <form:form action="/admin/speci/updateP" method="post" commandName="speciP" role="form">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="introduction" name="introduction" placeholder="Ente introduction:"
                   value="${speci.introduction}"/>
        </div>
        <div class="form-group">
            <label for="place"> place:</label>
            <input type="text" class="form-control" id="place" name="place" placeholder="Ente place:"
                   value="${speci.place}"/>
        </div>
        <!-- 把 id 一并写入 userP 中 -->
        <input type="hidden" id="id" name="id" value="${speci.id}"/>
