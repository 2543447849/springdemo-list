...
public class SpeciController {
    ...
    public String getSpeci(ModelMap modelMap) {
        // 查询user表中所有记录
    ...
    public String addUserPost(@ModelAttribute("user") SpeciEntity speciEntity) {
...
//        System.out.println(userEntity.getLastName());
        ...
        speciEntity.setCreateTime(new Date());
        speciEntity.setModifyTime(new Date());
        // 数据库中添加一个用户，并立即刷新缓存
